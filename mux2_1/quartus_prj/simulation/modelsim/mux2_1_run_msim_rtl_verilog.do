...
vlog -vlog01compat -work work +incdir+H:/Projects/Quartus/mux2_1/rtl {H:/Projects/Quartus/mux2_1/rtl/mux2_1.v}

vlog -vlog01compat -work work +incdir+H:/Projects/Quartus/mux2_1/quartus_prj/../sim {H:/Projects/Quartus/mux2_1/quartus_prj/../sim/tb_mux2_1.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclone_ver -L rtl_work -L work -voptargs="+acc"  tb_mux2_1
