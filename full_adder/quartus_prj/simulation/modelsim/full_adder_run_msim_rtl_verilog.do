...
vlog -vlog01compat -work work +incdir+H:/Projects/Quartus/full_adder/rtl {H:/Projects/Quartus/full_adder/rtl/half_adder.v}
vlog -vlog01compat -work work +incdir+H:/Projects/Quartus/full_adder/rtl {H:/Projects/Quartus/full_adder/rtl/full_adder.v}

vlog -vlog01compat -work work +incdir+H:/Projects/Quartus/full_adder/quartus_prj/../sim {H:/Projects/Quartus/full_adder/quartus_prj/../sim/tb_full_adder.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclone_ver -L rtl_work -L work -voptargs="+acc"  tb_full_adder
