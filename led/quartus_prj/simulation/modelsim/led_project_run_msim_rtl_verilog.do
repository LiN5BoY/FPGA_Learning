...
vlog -vlog01compat -work work +incdir+H:/Projects/Quartus/led/rtl {H:/Projects/Quartus/led/rtl/led.v}

vlog -vlog01compat -work work +incdir+H:/Projects/Quartus/led/quartus_prj/../sim {H:/Projects/Quartus/led/quartus_prj/../sim/tb_led.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclone_ver -L rtl_work -L work -voptargs="+acc"  tb_led
