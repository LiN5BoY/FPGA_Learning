...
vlog -vlog01compat -work work +incdir+H:/Projects/Quartus/water_led/rtl {H:/Projects/Quartus/water_led/rtl/water_led.v}

vlog -vlog01compat -work work +incdir+H:/Projects/Quartus/water_led/quartus_prj/../sim {H:/Projects/Quartus/water_led/quartus_prj/../sim/tb_water_led.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclone_ver -L rtl_work -L work -voptargs="+acc"  tb_water_led
