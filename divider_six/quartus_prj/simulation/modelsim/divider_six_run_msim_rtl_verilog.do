...
vlog -vlog01compat -work work +incdir+H:/Projects/Quartus/divider_six/rtl {H:/Projects/Quartus/divider_six/rtl/divider_six.v}

vlog -vlog01compat -work work +incdir+H:/Projects/Quartus/divider_six/quartus_prj/../sim {H:/Projects/Quartus/divider_six/quartus_prj/../sim/tb_divider_six.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclone_ver -L rtl_work -L work -voptargs="+acc"  tb_divider_six
